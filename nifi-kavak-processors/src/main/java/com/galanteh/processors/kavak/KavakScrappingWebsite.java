...
public class KavakScrappingWebsite implements Runnable {
    ...
    public final String seed_url = "https://www.kavak.com/compra-de-autos";
     ...
     * https://www.kavak.com/comprar-Acura/ano-2019-2018-2017/km-15000-a-20789/compra-de-autos
     * @return URL
     */
    private String get_url_with_filters() {
        String new_url = this.seed_url;
        if (this.manufacturer_filter != "") {
            ...
            Integer offset = this.seed_url.indexOf("/compra-de-autos");
    ...
    public List<String> get_list_pagination_urls() {
        ...
        try {
            ...
            Integer offset = url_filters.indexOf("https://www.kavak.com/");
            offset = offset + 22;
